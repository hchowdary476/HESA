...
FIELD_DEFINITIONS: dict[str, FieldDefinition] = {
    ...
    "general.camera_mode_enabled": FieldDefinition("general.camera_mode_enabled", "bool", False, env_var="JARVIS_CAMERA_MODE_ENABLED"),
    ...
    "ai.active_model": FieldDefinition("ai.active_model", "string", "Gemini 1.5 Pro"),
    "ai.active_provider": FieldDefinition("ai.active_provider", "string", "Google"),
    ...
    "ai.timeout": FieldDefinition("ai.timeout", "float", 30.0, env_var="JARVIS_AI_TIMEOUT", minimum=1.0),
    "voice.voice_enabled": FieldDefinition("voice.voice_enabled", "bool", True, env_var="JARVIS_VOICE_ENABLED", restart_required=True),
    "voice.wake_word": FieldDefinition("voice.wake_word", "string", "hesa", env_var="JARVIS_WAKE_WORD", restart_required=True),
    "voice.wake_word_enabled": FieldDefinition(
        "voice.wake_word_enabled", "bool", True, env_var="JARVIS_WAKE_WORD_ENABLED", restart_required=True
    ),
    ...
    "voice.energy_threshold": FieldDefinition(
        "voice.energy_threshold", "int", 300, env_var="JARVIS_ENERGY_THRESHOLD", minimum=1, maximum=10000
    ),
    "voice.pause_threshold": FieldDefinition(
        "voice.pause_threshold", "float", 1.0, env_var="JARVIS_PAUSE_THRESHOLD", minimum=0.1, maximum=10.0
    ),
    "voice.tts_enabled": FieldDefinition("voice.tts_enabled", "bool", True, env_var="JARVIS_TTS_ENABLED"),
    "voice.tts_provider": FieldDefinition(
        "voice.tts_provider", "string", "edge", env_var="JARVIS_TTS_PROVIDER", allowed_values=("edge", "piper", "elevenlabs")
    ),
    ...
    "runtime.action_sequence_delay": FieldDefinition(
        "runtime.action_sequence_delay", "float", 0.1, env_var="JARVIS_ACTION_SEQUENCE_DELAY", minimum=0.0
    ),
    "runtime.app_launch_delay": FieldDefinition("runtime.app_launch_delay", "float", 0.2, env_var="JARVIS_APP_LAUNCH_DELAY", minimum=0.0),
    "runtime.cpu_sample_interval": FieldDefinition(
        "runtime.cpu_sample_interval", "float", 0.1, env_var="JARVIS_CPU_SAMPLE_INTERVAL", minimum=0.0
    ),
    "runtime.screenshot_delay": FieldDefinition("runtime.screenshot_delay", "float", 0.2, env_var="JARVIS_SCREENSHOT_DELAY", minimum=0.0),
    "runtime.sleep_action_delay": FieldDefinition(
        "runtime.sleep_action_delay", "float", 1.0, env_var="JARVIS_SLEEP_ACTION_DELAY", minimum=0.0
    ),
    "runtime.type_delay": FieldDefinition("runtime.type_delay", "float", 0.1, env_var="JARVIS_TYPE_DELAY", minimum=0.0),
    "runtime.allow_destructive_actions": FieldDefinition(
        "runtime.allow_destructive_actions", "bool", False, env_var="JARVIS_ALLOW_DESTRUCTIVE_ACTIONS"
    ),
    ...
    "plugins.security_mode": FieldDefinition(
        "plugins.security_mode", "string", "strict", allowed_values=("strict", "standard", "development")
    ),
    ...
    "spotify.redirect_uri": FieldDefinition(
        "spotify.redirect_uri", "string", "http://127.0.0.1:8888/callback", env_var="SPOTIFY_REDIRECT_URI"
    ),
