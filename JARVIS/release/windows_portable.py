...
from JARVIS.release.artifact_verifier import verify_release_artifact
from JARVIS.release.portable_policy import DEFAULT_APP_NAME, GUIDANCE_FOLDERS, portable_layout
...
def build_windows_portable_plan(
    ...
    *,
    ...
    pyinstaller_command = [
        ...
        app_name,
        "--add-data",
        "JARVIS/ui/world_map/world_map.html;JARVIS/ui/world_map",
        "--add-data",
        "JARVIS/ui/jarvis_os/jarvis_os.html;JARVIS/ui/jarvis_os",
    ]
    if os.path.exists("jarvis.ico"):
        pyinstaller_command.append("--icon=jarvis.ico")
    pyinstaller_command.append(entrypoint)
    return {
        "version": version,
        "app_name": app_name,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--entrypoint", default="jarvis.py", help="PyInstaller entrypoint.")
