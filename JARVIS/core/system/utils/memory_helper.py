    ...
    try:
        ...
        for proc in psutil.process_iter(['pid', 'cmdline']):
            try:
                ...
                if "JARVIS" in cmd or any(svc in cmd for svc in ["voice_service", "gesture_service", "service_coordinator", "ai_agents_service", "cloud_service", "supervisor", "ui_jarvis_os"]):
