...
SETTINGS_GUIDE = [
    {
        ...
        "default": "hesa",
        "safe_default": "hesa",
        "description": "Wake word used to activate HESA. Safe default: keep it short, unique, and easy to say.",
    },
    {
        "key": "JARVIS_ACTIVE_TIMEOUT",
        "default": "60",
        "safe_default": "60",
        "description": "Seconds HESA stays actively listening after wake-up before returning to standby.",
    },
    {
