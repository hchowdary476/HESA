...
def load_logs() -> list:
    ...
    for filename in files:
        ...
        try:
            ...
            LOGS_TAMPERED = True
            logs.append({"timestamp": filename.split("_")[0], "error": "TAMPERED / INTEGRITY_FAILURE", "details": str(e)})
    return logs
...
def send_webhook_notification(payload: dict) -> bool:
    ...
    try:
        ...
        req = urllib.request.Request(settings["webhook_url"], data=req_data, headers={"Content-Type": "application/json"})
