...
GOODBYES = [
    "It's been a pleasure serving you today, sir. Hesa signing off.",
    ...
    "Goodbye, sir. It was an honour, as always. Hesa shutting down.",
...
def greet(*, speak, send_log, logger=None) -> None:
    ...
    if hour < 12:
        greeting = "Good morning, sir. All systems online. Hesa is ready, sir."
    elif 12 <= hour < 17:
        greeting = "Good afternoon, sir. All systems online. Hesa is ready, sir."
    elif 17 <= hour < 22:
        greeting = "Good evening, sir. All systems online. Hesa is ready, sir."
    else:
        greeting = "Good night, sir. All systems online. Hesa is ready, sir."

    safe_speak(greeting, speak=speak, send_log=send_log, logger=logger)
    send_log(f"HESA: {greeting}")
