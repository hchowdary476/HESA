...
class MediumAssistantFeaturesTests(unittest.TestCase):
    def test_groq_rate_limit_activates_cooldown_fallback(self):
        ...
        with (
            ...
            patch("JARVIS.core.automation.groq_router.activate_groq_cooldown") as cooldown_mock,
            patch.dict(os.environ, {"GROQ_API_KEY": "dummy-key"}),
        ):
    ...
    def test_summarize_clipboard_uses_local_fallback_when_cloud_summary_missing(self):
        ...
        with patch("JARVIS.core.automation.domains.runtime_actions.pyperclip.paste", return_value=text):
