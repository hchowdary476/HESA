...
from JARVIS.core.security.public_release import build_public_release_check
...
class ReleaseReadinessTest(TestCase):
    ...
    def test_readiness_cleans_only_cache_artifacts_created_during_check(self):
        with TemporaryDirectory() as temp_dir:
            ...
            generated_pyc = generated_cache / "JARVIS.core.security.public_release.cpython-311.pyc"
            calls = {"count": 0}
            ...
            with patch("JARVIS.core.security.public_release._run_hygiene_subprocess", side_effect=fake_hygiene):
                check = build_public_release_check(
                    root=root,
                    env={},
                    required_files=[],
