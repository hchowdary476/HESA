...
class TestMemoryOptimization(unittest.TestCase):
    ...
    def test_trimming_rules(self):
        ...
        with patch("psutil.virtual_memory") as mock_vm, \
             patch("JARVIS.core.system.utils.memory_helper.is_system_idle", return_value=False):
        ...
        with patch("psutil.virtual_memory") as mock_vm, \
             patch("JARVIS.core.system.utils.memory_helper.is_system_idle", return_value=True):
            mock_vm.return_value.percent = 90.0
            eligible = memory_helper.trim_memory_if_eligible()
            self.assertFalse(eligible)
