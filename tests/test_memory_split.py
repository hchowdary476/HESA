...
import JARVIS.core.memory.memory_habits as memory_habits
import JARVIS.core.memory.memory_notes as memory_notes
import JARVIS.core.memory.memory_preferences as memory_preferences
import JARVIS.core.memory.memory_short_term as memory_short_term
...
class MemorySplitTests(unittest.TestCase):
    ...
    def test_preferences_and_notes_are_routed(self):
        with patch("JARVIS.core.memory.memory_preferences.set_preference") as set_pref:
