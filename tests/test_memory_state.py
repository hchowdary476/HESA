...
import JARVIS.core.memory.memory_state as memory_state
...
class MemoryStateTests(unittest.TestCase):
    ...
    def test_detect_and_save_preference_routes_music_and_volume(self):
        with patch("JARVIS.core.memory.memory_preferences.set_preference") as set_preference:
    ...
    def test_memory_state_reexports_split_modules(self):
        from JARVIS.core.memory import memory_short_term
