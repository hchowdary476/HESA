...
from JARVIS.release.windows_portable import assemble_portable_package, build_windows_portable_plan, run_windows_portable_build
...
class BuildScriptDryRunTest(TestCase):
    def test_build_plan_defaults_to_onedir_gui_entrypoint(self):
        ...
        self.assertIn("jarvis.py", plan["pyinstaller_command"])
