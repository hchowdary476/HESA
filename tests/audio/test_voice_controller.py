...
from JARVIS.core.voice.tts_queue import TTSQueue
from JARVIS.core.voice.voice_controller import VoiceController
from JARVIS.core.voice.voice_state import VoiceState
...
class VoiceControllerTest(TestCase):
    def test_controller_processes_wake_command_and_response(self):
        ...
        result = controller.handle_wake_phrase("hesa")
