...
from JARVIS.runtime import voice_personality
...
class VoicePersonalityTest(unittest.TestCase):
    def test_greet_routes_morning_message(self):
        ...
        with patch("JARVIS.runtime.voice_personality.datetime.datetime") as dt:
    ...
    def test_say_goodbye_uses_goodbye_pool(self):
        ...
        with (
            patch("JARVIS.runtime.voice_personality.datetime.datetime") as dt,
            patch("JARVIS.runtime.voice_personality.random.choice", return_value="Farewell, sir."),
        ):
    ...
    def test_say_goodbye_reports_tts_failure_without_raising(self):
        ...
        with patch("JARVIS.runtime.voice_personality.random.choice", return_value="Farewell, sir."):
    ...
    def test_maybe_tell_joke_updates_state(self):
        ...
        with (
            patch("JARVIS.runtime.voice_personality.random.randint", return_value=6),
            patch("JARVIS.runtime.voice_personality.random.choice", return_value="A joke, sir."),
        ):
        ...
        self.assertEqual(spoken[-1], "HESA: A joke, sir.")
