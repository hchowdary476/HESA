...
class RuntimeHelpersTest(unittest.TestCase):
    ...
    @patch("JARVIS.runtime.process_runner.subprocess.Popen")
    ...
    def test_read_runtime_events_ignores_malformed_json_lines(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            with patch("JARVIS.core.system.observability.EVENT_LOG", event_file):
    ...
    @patch("JARVIS.core.system.observability.read_runtime_events")
    @patch("JARVIS.core.system.observability.build_slo_report")
