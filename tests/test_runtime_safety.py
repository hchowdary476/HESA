...
from JARVIS.runtime.runtime_safety import build_confirmation_prompt, is_destructive_action_allowed, requires_confirmation
...
class RuntimeSafetyTests(unittest.TestCase):
    def test_destructive_actions_are_blocked_by_default(self):
        ...
        with patch("JARVIS.core.automation.domains.runtime_actions.run_command") as run_mock:
    ...
    def test_cpu_check_uses_fast_configurable_interval(self):
        ...
        with (
            ...
            patch("JARVIS.core.automation.domains.runtime_actions.psutil.cpu_percent", return_value=12) as cpu_mock,
        ):
    ...
    def test_runtime_delays_are_configurable(self):
        from JARVIS.core.automation.domains.runtime_actions import app_launch_delay, desktop_action_delay
